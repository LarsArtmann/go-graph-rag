...
| Release automation (`release.yml`)                         | 🟢 `FULLY_FUNCTIONAL` | `.github/workflows/release.yml`; fires on `v*` tags, extracts notes from the matching CHANGELOG section; failed its first real run (v0.2.0, awk extraction bug, fixed `350b815`, manual release), then proven end-to-end on v0.3.0 (green run, correct notes, 2026-09-19) |
